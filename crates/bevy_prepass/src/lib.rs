...
/// If added to a `Camera3d` then depth values will be copied to a separate texture available to the main pass.
#[derive(Component, Default, Reflect)]
pub struct DepthPrepass;

/// If added to a `Camera3d` then vertex world normals will be copied to a separate texture available to the main pass.
